...
public class MaterialIdLib {
    ...
    public static Material getMaterialById(int id) {
        if (materials.containsValue(id)) for (Material m : materials.keySet()) if (id == materials.get(m)) return m;
    ...
    public static List<Material> getAvailableMaterials() {
        ...
        for (Material m : materials.keySet()) mats.add(m);
    ...
    public static List<Integer> getAvailableIds() {
        ...
        for (Material m : materials.keySet()) ids.add(materials.get(m));
